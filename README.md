...
**LeaderBoard** the leaderboard application consumes the Leaderboard API using JavaScript async and await and add some styling.
...
- cd [my-folder]
-[git clone] (git@github.com:derrick1451/LeaderBoard.git)
-cd [repo-name]
-code .
...
Feel free to check the [issues page](https://github.com/derrick1451/LeaderBoard/issues).
